        ...
        <el-row :gutter="10" class="mb8">
          ...
          <el-col :span="1.5">
            <el-button
              ...
              size="mini"
              @click="handleImport"
              v-hasPermi="['system:operator:import']"
            >导入</el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button
...
<!--          <el-table-column label="部门" align="center" key="deptName" prop="dept.deptName" v-if="columns[3].visible" :show-overflow-tooltip="true" />-->
          ...
          >
            <template slot-scope="scope" v-if="scope.row.id !== 1473141102158827500">
              <el-button
                size="mini"
                type="text"
                icon="el-icon-edit"
              ...
              <el-button
                ...
                v-hasPermi="['system:operator:remove']"
              >删除</el-button>
              <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)" v-hasPermi="['system:operator:resetPwd', 'system:operator:edit']">
                <span class="el-dropdown-link">
                  <i class="el-icon-d-arrow-right el-icon--right"></i>更多
                </span>
                <el-dropdown-menu slot="dropdown">
                  <el-dropdown-item command="handleResetPwd" icon="el-icon-key"
                    v-hasPermi="['system:operator:resetPwd']">重置密码</el-dropdown-item>
                  <el-dropdown-item command="handleAuthRole" icon="el-icon-circle-check"
                    v-hasPermi="['system:operator:edit']">分配角色</el-dropdown-item>
                </el-dropdown-menu>
              </el-dropdown>
            </template>
          </el-table-column>
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/system/operator/importData"
      },
      // 查询参数
      queryParams: {
        pageNum: 1,
