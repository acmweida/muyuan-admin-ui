<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="featureList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="HTML元素类型" align="center" prop="htmlType" />
      <el-table-column label="父属性ID" align="center" prop="parentId" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="父属性ID" prop="parentId">
          <el-input v-model="form.parentId" placeholder="请输入父属性ID" />
        </el-form-item>
...
<script>
import { listFeature, getFeature, delFeature, addFeature, updateFeature } from "@/api/product/feature";
